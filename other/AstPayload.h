...
#undef DECL_AST_TYPE
    ...
    private:
        ...
        const Type* resolvedReturnType              = Type::GetErrorType();
    };
    ...
    private:
        // Struct type that this decl introduces
        const Type* blockType = Type::GetErrorType();
        ...
        const Type* instanceType = Type::GetErrorType();
    ...
    private:
        ...
        // const Type* contextualType = Type::GetErrorType();
    };
